...
int main(){
    Ecuacion polinomio;
    polinomio.pedirEcuacion(); //Lectura de funcion
    polinomio.Hallarderivada(); //Primera derivada
    polinomio.Hallarderivada2(); //Segunda derivada
    ...
    cout << "\nPRIMERA DERIVADA ES: "; polinomio.escribirEcuacion(2);
    cout << "\nSEGUNDA DERIVADA ES: "; polinomio.escribirEcuacion(3);
    ...
    do{
        ...
        valorActual = valorActual - ( (polinomio.evaluarFuncion(valorActual))*(polinomio.evaluarDerivada(valorActual) ) / ( pow(polinomio.evaluarDerivada(valorActual),2) - (polinomio.evaluarFuncion(valorActual))*(polinomio.evaluarDerivada2(valorActual))) );
